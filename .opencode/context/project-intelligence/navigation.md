<!-- Context: project-intelligence/nav | Priority: high | Version: 1.1 | Updated: 2026-03-28 -->
...
| Understand the "how" | `technical-domain.md` | Stack, architecture, patterns (Node.js + CommonJS + CLI) |
